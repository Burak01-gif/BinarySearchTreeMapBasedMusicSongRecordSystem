...
public class Test {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i<10; i++){
            String[] temp = Files.readAllLines(Paths.get("C:\\Users\\ezero\\java_projects\\java_entry\\COMP2102 Data Structure\\proje2\\untitled2\\src\\sound.txt")).get(i).split(";");
        ...
        for (int k = 0;k<10;k++){
            String[] temp2 = Files.readAllLines(Paths.get("C:\\Users\\ezero\\java_projects\\java_entry\\COMP2102 Data Structure\\proje2\\untitled2\\src\\sound.txt")).get(k).split(";");
            for (int j = 0; j<5;j++){
                songs2[k][j]=temp2[j];
            }
        }
